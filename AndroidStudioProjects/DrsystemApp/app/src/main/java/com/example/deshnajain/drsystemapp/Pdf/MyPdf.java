package com.example.deshnajain.drsystemapp.Pdf;
...
public class MyPdf {
    ...
    public Boolean write(Context context, String fname,  ArrayList<NotificationTable> myProducts) {
        try {
            ...
            for (int i=1;i<myProducts.size();i++){
                ...
                table.addCell(myProducts.get(i).getTitle());
                table.addCell(myProducts.get(i).getDes());
            }
